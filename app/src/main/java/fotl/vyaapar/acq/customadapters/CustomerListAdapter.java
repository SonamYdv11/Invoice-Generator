...
import fotl.vyaapar.acq.CustomerList;
...
public class CustomerListAdapter extends ArrayAdapter<String> {
    ...
    public CustomerListAdapter(AppCompatActivity activity, int resource, int textViewResourceId, List<String> objects) {
    ...
    public View getView(int position, @android.support.annotation.NonNull View convertView, @android.support.annotation.NonNull ViewGroup parent) {
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent1 = new Intent(activity, CustomerMaster.class );
